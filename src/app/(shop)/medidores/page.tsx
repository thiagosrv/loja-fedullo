...
export const metadata: Metadata = {
  title: "Medidores",
  description: "Instrumentação de alta precisão para carros preparados.",
};
...
export default async function MedidoresPage({ searchParams }: Props) {
  ...
  const where: Prisma.ProductWhereInput = { active: true, category: { slug: "medidores" } };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-white">Medidores</h1>
        <p className="text-[#9ca3af] mt-1">Instrumentação de alta precisão para carros preparados</p>
      </div>
