...
export const metadata: Metadata = {
  title: "Peças",
  description: "Peças e acessórios para preparação automotiva.",
};
...
export default async function PecasPage({ searchParams }: Props) {
  ...
  const where: Prisma.ProductWhereInput = { active: true, category: { slug: "pecas" } };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        ...
        <p className="text-[#9ca3af] mt-1">Peças e acessórios para preparação automotiva</p>
      </div>
